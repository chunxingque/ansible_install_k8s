...
download_file https://dl.k8s.io/v1.27.5/kubernetes-server-linux-amd64.tar.gz kubernetes-server-linux-amd64.tar.gz
download_file https://github.com/containerd/containerd/releases/download/v1.7.5/cri-containerd-cni-1.7.5-linux-amd64.tar.gz cri-containerd-cni-1.7.5-linux-amd64.tar.gz
