...
set -e
echo -e "######################## \033[42m localhost unzip k8s binary_package \033[0m ##############################"
ansible-playbook playbook/k8s_master.yaml --tags unzip_package -i k8s_hosts
echo -e "######################## \033[42m master install helm & kubectl & cfssl \033[0m ##############################"
ansible-playbook playbook/k8s_master.yaml --tags k8s_command -i k8s_hosts
echo -e "################################### \033[42m generate certificate \033[0m ####################################"
